    ...
    <div class="left-column">
      ...
      <div class="light-panel">
        ...
        <div class="light-panel-center">
          ...
          <ul>
            <li><a href='<?php echo base_url()?>index.php/admin_controller/login'>+ TSO Login</a></li>
            <li><a href='<?php echo base_url()?>index.php/User_controller/login'>+ User Login</a></li>
            <li><a href='<?php echo base_url()?>index.php/dist_controller/login'>+ Distributor Login</a></li>
            <li><a href='<?php echo base_url()?>index.php/shop_owner_controller/login'>+ Shop owner Login</a></li>
            <li><a href='<?php echo base_url()?>index.php/User_controller/guest'>+ Registration</a></li>
            <li><a href='<?php echo base_url()?>index.php/User_controller/login'>+ Suspendisse sollicitudin enim</a></li>
