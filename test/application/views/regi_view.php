			   ...
			   <!-- Collect the nav links, forms, and other content for toggling -->
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					<ul class="nav navbar-nav nav_1">
						<li><a href="<?php echo base_url(); ?>products.html">Branded Foods</a></li>
						<li><a href="<?php echo base_url(); ?>household.html">Households</a></li>
						...
						<li><a href="<?php echo base_url(); ?>kitchen.html">Kitchen</a></li>
						<li><a href="<?php echo base_url(); ?>short-codes.html">Short Codes</a></li>
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">Beverages<span class="caret"></span></a>
							<div class="dropdown-menu mega-dropdown-menu w3ls_vegetables_menu">
								<div class="w3ls_vegetables">
									<ul>
										<li><a href="<?php echo base_url(); ?>drinks.html">Soft Drinks</a></li>
										<li><a href="<?php echo base_url(); ?>drinks.html">Juices</a></li>
									</ul>
								</div>                  
							</div>	
						</li>
						<li><a href="<?php echo base_url(); ?>pet.html">Pet Food</a></li>
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">Frozen Foods<span class="caret"></span></a>
							<div class="dropdown-menu mega-dropdown-menu w3ls_vegetables_menu">
								<div class="w3ls_vegetables">
									<ul>
										<li><a href="<?php echo base_url(); ?>frozen.html">Frozen Snacks</a></li>
										<li><a href="<?php echo base_url(); ?>frozen.html">Frozen Nonveg</a></li>
									</ul>
								</div>                  
							</div>	
						</li>
						<li><a href="<?php echo base_url(); ?>bread.html">Bread & Bakery</a></li>
					</ul>
				 </div><!-- /.navbar-collapse -->
			</nav>
		</div>
					...
					<ul class="slides">
						<li>
							<div class="w3l_banner_nav_right_banner">
								...
								<div class="more">
									<a href="<?php echo base_url(); ?>products.html" class="button--saqui button--round-l button--text-thick" data-text="Shop now">Shop now</a>
								</div>
							</div>
						</li>
						<li>
						...
						<div class="agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="single.html"><img src="<?php echo base_url(); ?>images/2.png" alt=" " class="img-responsive" /></a>
